 ...
 * 
 * Google Apps Script Engine (JavaScript Ready-to-Paste)
 * Integrates Google Sheets (Live Database), Google Drive (Receipt PDFs), and Excel Export
 */

const CONFIG = {
  RECEIPT_FOLDER_NAME: "IS3A3_2026_Payment_Receipts",
  RECEIPT_FOLDER_ID: "", // Paste a specific Google Drive Folder ID if desired
...
function savePdfToGoogleDrive(base64Data, originalFileName, registrationId) {
  try {
    let targetFolder;
...
function sendConfirmationEmail(payload, driveUrl) {
  try {
